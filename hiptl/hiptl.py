...
print("opening the hih2file for chunk " + CHUNK) 
hih2file = hp.File(BASE+"hih2_particles_099."+CHUNK+".hdf5")
print("successfully opened the hih2file")
print("opening particle file")
ptlfile = hp.File(HOME+"snap_099."+CHUNK+".hdf5")
print("successfully opened the ptlfile")
